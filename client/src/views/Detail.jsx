...
const Detail = () => {
    ...
    return (
        <>
            <Link className='btn btn-light my-3' to="/">Atrás</Link>
            {loading ? <Loader/> : error ? <Message variant='danger'>{error}</Message> : (
                <>
                    <Row>
                    <Col md={6}>
                        <Image className='img2' src={product.image} alt={product.name} fluid />
                    </Col>
                    <Col md={3}>
                        <ListGroup variant='flush'>
                            ...
                            <ListGroup.Item>
                                <Rating value={product.rating} text={` de ${product.numReviews} reseñas`}/>
                            </ListGroup.Item>
                            <ListGroup.Item>
