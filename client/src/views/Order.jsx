        ...
        <Col md={8}>
          <ListGroup variant="flush">
            <ListGroup.Item>
              ...
              <p>
                <strong>Email: </strong>
                <a href={`emailto:${order.user.email}`}>{order.user.email}</a>
              </p>
              <p>
              ...
              {order.isDelivered ? (
                ...
                <Message variant="info">
                  Una vez que comprobemos tu pago, envíaremos tu pedido.
                </Message>
              )}
            </ListGroup.Item>
            ...
            <ListGroup.Item>
              ...
              {order.orderItems.length === 0 ? (
                <Message variant="danger">Pedido esta vacío</Message>
              ) : (
                <ListGroup variant="flush">
